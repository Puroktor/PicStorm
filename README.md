...
Клиент использует Single Activity подход. Навигация между его фрагментами, осуществляется с помощью Navigation Component, в соотвествии с графом. Установочный файл приложения присутствует в репозитории.
